  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="w-full max-w-sm space-y-6 bg-white rounded ">
        ...
        {/* Title */}
        <h2 className="text-center text-lg font-medium text-ui-dark">Log in to your account</h2>
        ...
        <form className="space-y-4 flex-center flex-col">
          ...
          <button
            type="submit"
            disabled={!isValid}
            className={`h-[50px] w-100 py-2 bg-brand-primary/80 hover:bg-brand-primary text-white font-semibold rounded-md transition-all duration-300 ${
              isValid
